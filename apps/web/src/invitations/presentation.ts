...
export const themeVisualConfig: Record<RendererKey, ThemeVisual> = {
  "elegant-classic": {
    ...
    bodyFontFamily: "var(--font-invitation-elegant-body)",
    bodyFontName: "Montserrat",
    headingFontFamily: "var(--font-invitation-elegant-heading)",
  ...
  "islamic-soft": {
    ...
    cardShineColor: "#FFFFFF",
    bodyFontFamily: "var(--font-invitation-islamic-body)",
    bodyFontName: "Lora",
    headingFontFamily: "var(--font-invitation-islamic-heading)",
    headingFontName: "Marcellus",
  ...
  "luxury-gold": {
    ...
    bodyFontFamily: "var(--font-invitation-luxury-body)",
    bodyFontName: "Manrope",
    headingFontFamily: "var(--font-invitation-luxury-heading)",
    headingFontName: "Bodoni Moda",
  ...
  "minimalist-white": {
    ...
    cardShineColor: "#FFFFFF",
    bodyFontFamily: "var(--font-invitation-minimalist-body)",
    bodyFontName: "Inter",
    headingFontFamily: "var(--font-invitation-minimalist-heading)",
    headingFontName: "Italiana",
  ...
  "dark-cinematic": {
    ...
    bodyFontFamily: "var(--font-invitation-cinematic-body)",
    bodyFontName: "DM Sans",
    headingFontFamily: "var(--font-invitation-cinematic-heading)",
    headingFontName: "Cormorant SC",
  ...
  "floral-romantic": {
    ...
    cardShineColor: "#FFFFFF",
    bodyFontFamily: "var(--font-invitation-floral-body)",
    bodyFontName: "Nunito Sans",
    headingFontFamily: "var(--font-invitation-floral-heading)",
    headingFontName: "Great Vibes",
  ...
  "javanese-traditional": {
    ...
    bodyFontFamily: "var(--font-invitation-javanese-body)",
    bodyFontName: "Noto Sans",
    headingFontFamily: "var(--font-invitation-javanese-heading)",
    headingFontName: "Noto Serif",
