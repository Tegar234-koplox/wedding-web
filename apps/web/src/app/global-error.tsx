...
export default function GlobalError({
  ...
  return (
    <html lang="id">
      <body className="grid min-h-screen place-items-center bg-[#11110f] px-6 text-center text-[#f4efe5]">
        <main>
          <p className="text-xs uppercase tracking-[0.24em] text-[#c6a75b]">
            Niskala
          </p>
          <h1 className="mt-5 font-serif text-5xl">Something went quiet.</h1>
          <p className="mx-auto mt-5 max-w-md text-sm leading-7 text-white/65">
            The page could not be completed. Please try again in a moment.
          </p>
          <button
