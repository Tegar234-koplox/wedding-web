...
BESPOKE_ENGINE_ENABLED = env_bool("BESPOKE_ENGINE_ENABLED", True)
META_WHATSAPP_ACCESS_TOKEN = env("META_WHATSAPP_ACCESS_TOKEN", "")
META_WHATSAPP_PHONE_NUMBER_ID = env("META_WHATSAPP_PHONE_NUMBER_ID", "")
META_WHATSAPP_OTP_TEMPLATE_ID = env("META_WHATSAPP_OTP_TEMPLATE_ID", "")
META_WHATSAPP_GRAPH_VERSION = env("META_WHATSAPP_GRAPH_VERSION", "v23.0")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", "Niskala <no-reply@niskalastudio.site>")
EMAIL_BACKEND = env(
    "EMAIL_BACKEND",
