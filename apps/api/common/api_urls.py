...
from common.views import (
    ...
    StaffMFAConfirmView,
    StaffMFAEnrollView,
    StaffMFAFirstLoginConfirmView,
    StaffMFAFirstLoginEnrollView,
    StaffMFALoginView,
    StaffMFAReauthView,
    StaffMFAResetView,
    StaffSessionMeView,
...
urlpatterns = [
    ...
    path(
        ...
        StaffMFAFirstLoginEnrollView.as_view(),
        name="api-staff-login-mfa-enroll",
    ),
    path(
        "auth/login/mfa/confirm",
        StaffMFAFirstLoginConfirmView.as_view(),
        name="api-staff-login-mfa-confirm",
    ),
